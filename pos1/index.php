...
<body>
    <div class="container p-4">
        <div class="d-flex justify-content-end">
            <a href="insert.php" class="btn btn-primary"> Add Item +</a>
        </div>
        <?php
            ...
            <div class="col-12">
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <div class="d-flex justify-content-end">
                            <a href="edit.php?id=<?=$item['id']?>" class="btn btn-primary mr-1"><i class="fa fa-pencil"></i></a>
                            <a href="delete.php?id=<?=$item['id']?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                        </div>
                    </div>
                </div>
            </div>
